            ...
            <div v-if="currentDetail" class="detail-content">
                ...
                <div class="detail-section">
                    ...
                    <el-descriptions :column="1" border>
                        ...
                        <el-descriptions-item label="日志内容"> {{ currentDetail.diaryContent ||
                            '无' }}</el-descriptions-item>
                    </el-descriptions>
                </div>
                <div class="detail-section">
...
// 详情
const detailDialogVisible = ref(false) // 控制详情对话框的显示与隐藏
const currentDetail = ref(null) // 保存当前详情数据
...
const viewSessionDetail = (row) => {
    ...
    if (row.aiEmotionAnalysis) {
        ...
        console.log(aiData.value) // 打印AI情绪分析数据
    } else {
        aiData.value = {}
    }
...
const handleDelete = (row) => {
    ...
    ElMessageBox.confirm('确定要删除该情绪日志吗?', '删除确认', {
